(module
 ...
 (global $assembly/index/array i32 (i32.const 256))
 (global $assembly/index/charCodeCache i32 (i32.const 336))
 ...
 (export "leven" (func $assembly/index/leven))
 ...
 (func $assembly/index/leven (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  ...
  loop $for-loop|2
   ...
   local.get $6
   if
    global.get $assembly/index/charCodeCache
    local.get $5
    local.get $0
    local.get $3
    local.get $5
